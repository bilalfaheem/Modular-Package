...
abstract class Network {
  ...
  Future<Either<NetworkFailure, dynamic>> put(String url, Map<String, dynamic> data, Map<String, String>? header, {String? pathVariable});
  Future<Either<NetworkFailure, dynamic>> postFile(String url, Map<String, dynamic> data, Map<String, dynamic> file, Map<String, String>? header,
      {String? pathVariable});
  Future<Either<NetworkFailure, dynamic>> patchFile(String url, Map<String, dynamic> data, Map<String, dynamic> file, Map<String, String>? header,
      {String? pathVariable});
  Future<Either<NetworkFailure, dynamic>> putFile(String url, Map<String, dynamic> data, Map<String, dynamic> file, Map<String, String>? header,
      {String? pathVariable});
}
